                ...
                <div class="grid-1 grid gap-4 md:grid-cols-3 lg:grid-cols-5">
                    ...
                    <div>
                        ...
                        <div class="flex items-center">
                            <a href="https://www.facebook.com/ietnitk" target="_blank" class="mr-4 text-neutral-200">
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    class="h-4 w-4"
                                    fill="currentColor"
                            ...
                            <a href="https://www.linkedin.com/company/ietnitk/" target="_blank" class="mr-4 text-neutral-200">
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    class="h-4 w-4"
                                    fill="currentColor"
                            ...
                            <a href="https://www.github.com/IET-NITK" target="_blank" class=" text-neutral-200">
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    class="h-4 w-4"
                                    fill="currentColor"
