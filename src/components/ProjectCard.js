...
const ProjectCard = ({ project }) => {
  return (
    <div className="w-[350px] flex justify-between flex-col h-full mx-auto p-6 bg-gray-50 border border-gray-200 rounded-lg shadow relative hover:bg-gray-100 transition duration-300">
