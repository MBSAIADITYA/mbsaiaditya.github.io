...
<Link href={`/projects/${project.id}`}>
    <h6 className="mb-2 text-lg font-semibold text-fuchsia-900">{project.project_sig}</h6>
        <h5 className="mb-2 text-2xl font-bold tracking-tight text-fuchsia-700">{project.title}</h5>
    <p className="mb-3 font-normal text-gray-700">{project.project_description}</p>
    </Link>
